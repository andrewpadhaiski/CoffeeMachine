...
<html>
	...
	<body>
		...
		<section>	
			...
			<hr>	
			<fmt:message key="label.admin.button.fill.coffee" />
			<form name="coffeeForm" method="POST" action="controller">
				<input type="hidden" name="command" value="admin_ingredient" />
				<input type="submit" value="<fmt:message key="label.admin.button.fill.ingredient" />"/>
			</form>
			<table>
				<tr>
				...
				<c:forEach var="coffee" items="${coffees}" varStatus="status">
					<tr>
						...
						<td>
							<form name="coffeeForm" method="POST" action="controller">
								<input type="hidden" name="command" value="admin_coffee_fill" />
